...
public class Controle extends Baralho {
    ...
    public void trocarAsCartas() {
        ...
        int primeiroApostador = 0;
        boolean temDealer = false;

        for (int i = 0; i < getJogadores().length; i++) {
            if (getJogadores()[i] != null) {
                if (getJogadores()[i].getStatus().equals("Dealer")) {
                    temDealer = true;
                    break;
                }
            }
        ...
        if (jogadores[0] != null) {
            System.out.println("Carta *1* - " + jogadores[0].getC()[0].getNome() + ""
                    + jogadores[0].getC()[0].getNaipe() + "\nCarta *2* - " + jogadores[0].getC()[1].getNome() + ""
                    + jogadores[0].getC()[1].getNaipe() + "\nCarta *3* - " + jogadores[0].getC()[2].getNome() + ""
                    + jogadores[0].getC()[2].getNaipe() + "\nCarta *4* - " + jogadores[0].getC()[3].getNome() + ""
                    + jogadores[0].getC()[3].getNaipe() + "\nCarta *5* - " + jogadores[0].getC()[4].getNome() + ""
                    + jogadores[0].getC()[4].getNaipe());
        }
        ...
        for (int i = 0; i < jogadores.length; i++) {
            if (jogadores[vezDeQuem] != null) {
                if (vezDeQuem == 0) {
                    ...
                    while (desejaTrocar.equals("sim") == false && desejaTrocar.equals("nao") == false) {
                        desejaTrocar = Teclado.leString(
                                "Você deseja trocar alguma(s) carta(s) de sua mão? Digite *sim* em caso afirmativo ou *nao* em caso negativo: ");
                        minuscula = desejaTrocar.toLowerCase();
                        if (minuscula.equals("sim") == false && minuscula.equals("não") == false
                                && minuscula.equals("nao") == false) {
                            System.out.println("Desculpa, não consegui entender. Por favor, digite novamente.");
                        }
                    }

                    if (minuscula.equals("sim")) {
                        int nTrade = 0;
                        ...
                        for (int c = 0; c < nTrade; c++) {
                            int posicaoCarta = 0;
                            int x = 0;
                            while (posicaoCarta != 1 && posicaoCarta != 2 && posicaoCarta != 3 && posicaoCarta != 4
                                    && posicaoCarta != 5) {
                                posicaoCarta = Teclado
                                        .leInt("Digite o número da carta que você deseja trocar de sua mão: ");
                        ...
                        System.out.println("Carta *1* - " + jogadores[0].getC()[0].getNome() + ""
                                + jogadores[0].getC()[0].getNaipe() + "\nCarta *2* - "
                                + jogadores[0].getC()[1].getNome() + "" + jogadores[0].getC()[1].getNaipe()
                                + "\nCarta *3* - " + jogadores[0].getC()[2].getNome() + ""
                                + jogadores[0].getC()[2].getNaipe() + "\nCarta *4* - "
                                + jogadores[0].getC()[3].getNome() + "" + jogadores[0].getC()[3].getNaipe()
                                + "\nCarta *5* - " + jogadores[0].getC()[4].getNome() + ""
                                + jogadores[0].getC()[4].getNaipe());
                    }
                }
                    ...
                    if (jogadores[vezDeQuem].getAllIn() == true && jogadores[vezDeQuem].getFichas() == 0) {
                        ...
                        if (vezDeQuem == 0) {
                            ...
                            while (opcao < 1 || opcao > 2) {
                                opcao = Teclado.leInt(
                                        "O que você deseja fazer? Digite a opção desejada: \n1)Check \n2)Aumentar a Aposta(10)");
                                if (opcao < 1 && opcao > 2) {
                            ...
                            if (opcao == 1) {
                                System.out.println(
                                        "Aposta deu Check! Saldo de fichas: " + jogadores[vezDeQuem].getFichas());
                                rodadas++;
                                opcao = 0;
                            }
                            ...
                            if (opcao == 2) {
                                ...
                                while (aumento <= valorAPagar || aumento > jogadores[vezDeQuem].getFichas()) {
                                    aumento = Teclado.leInt(
                                            "Digite o valor de aposta que você deseja realizar. Saldo de fichas: "
                                                    + jogadores[vezDeQuem].getFichas());
                            ...
                            if (opcao == 1 || opcao == 2 || opcao == 3) {
                                ...
                                int aumento = (int) (Math.random() * (jogadores[vezDeQuem].getFichas() - valorAPagar))
                                        + valorAPagar + 1;
                                valorAPagar = aumento;
                                pote = pote + aumento;
                        ...
                        if (jogadores[vezDeQuem].getFichas() <= valorAPagar) {
                            ...
                            if (opcao == 1) {
                                ...
                                System.out.println("Aposta paga! Saldo de fichas: " + jogadores[vezDeQuem].getFichas());
                                System.out.println(jogadores[vezDeQuem].getNome() + " apostou "
                                        + jogadores[vezDeQuem].getFichas() + " fichas!");
                                jogadores[vezDeQuem].setValorAI(jogadores[vezDeQuem].getFichas());
                                jogadores[vezDeQuem].setAllIn(true);
                                jogadores[vezDeQuem]
                                        .setFichas(jogadores[vezDeQuem].getFichas() - jogadores[vezDeQuem].getFichas());
                                rodadas++;
                                opcao = 0;
                            }
                            ...
                            if (opcao == 1) {
                                ...
                                System.out.println("Aposta paga! Saldo de fichas: " + jogadores[vezDeQuem].getFichas());
                                System.out.println(
                                        jogadores[vezDeQuem].getNome() + " apostou " + valorAPagar + " fichas!");
                                rodadas++;
                                opcao = 0;
                            }
    ...
    public void rodada() {
            ...
            if (jogadores[x] == null) {
                ...
                if (jogadores[x].getParticipaDaRodada() == true) {
                    ...
                    if (espada == 5 || copas == 5 || ouro == 5 || paus == 5) {
                        ...
                        } else if (vC[0] + 1 == vC[1] && vC[1] + 1 == vC[2] && vC[2] + 1 == vC[3]
                                && vC[3] + 1 == vC[4]) {
                    ...
                    } else if (vC[0] == vC[1] && vC[1] == vC[2] && vC[2] == vC[3]
                            || vC[1] == vC[2] && vC[2] == vC[3] && vC[3] == vC[4]) {
                    ...
                    } else if (vC[0] == vC[1] && vC[1] == vC[2] || vC[1] == vC[2] && vC[2] == vC[3]
                            || vC[2] == vC[3] && vC[3] == vC[4]) {
                        if (vC[0] == vC[1] && vC[1] == vC[2] && vC[3] == vC[4]
                                || vC[1] == vC[2] && vC[2] == vC[3] && vC[0] == vC[4]
                                || vC[2] == vC[3] && vC[3] == vC[4] && vC[0] == vC[1]) {
                            if (vC[0] == vC[1] && vC[1] == vC[2] && vC[3] == vC[4]) {
        ...
        if (posicao != -1) {
            if (jogadores[posicao].getAllIn() == true && jogadores[posicao].getValorAI() < valorDaRodada) {
                ...
                System.out
                        .print("O jogador " + jogadores[posicao].getNome() + " ganhou a rodada e levou " + pp
                                + " fichas!");
                pote = pote - pote;
            } else {
                ...
                for (int i = 0; i < jogadores.length; i++) {
                    if (jogadores[i] != null) {
                        if (jogadores[i].getPontosNaRodada() == pontuacao) {
                            System.out.print("O jogador " + jogadores[posicao].getNome() + " ganhou a rodada e levou "
                                    + pote + " fichas!");
        ...
        for (int i = 0; i < jogadores.length; i++) {
            if (jogadores[i] != null) {
                if (jogadores[i].getFichas() < 1) {
                    System.out.println("");
                    System.out.println("O JOGADOR " + jogadores[i].getNome()
                            + " ACABOU FICANDO SEM FICHAS E SAINDO DA MESA DE JOGO!");
                    jogadores[i] = null;
